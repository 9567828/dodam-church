...
export default function Page() {
  ...
  return (
    <PowerPage
      pageTitle="파워틴즈"
      mainSrc={`${baseURL}teens-main.png`}
      pageIntro="도담교회 파워틴즈는 대한예수교 장로회 합동 교단에 소속된 교회의 중·고등부 공동체입니다. 
            중학생과 고등학생들이 함께 모여 예배하고, 말씀 안에서 성장하며 
            ‘예수님을 따라 세상 속에서 빛과 소금의 역할을 감당하는 청소년’이 되기 위하여 노력하는 공동체입니다."
