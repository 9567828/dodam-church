...
const activityList = [
  ...
  makeActivity({
    title: "성경공부",
    sub: "훈련",
    src: `${baseURL}bible-learn.png`,
    info: "예배 후 소그룹별로 성경 이야기를 공부합니다",
  }),
  makeActivity({
    title: "학교 앞 전도",
    sub: "전도",
    src: `${baseURL}evangelism.png`,
...
export default function Page() {
  ...
  return (
    <PowerPage
      pageTitle="파워키즈"
      mainSrc={`${baseURL}kids-main.png`}
      pageIntro="도담교회 파워키즈는 초등학교 1-6학년 어린이들이 함께 하나님을 예배하는 공동체입니다. 
                  예수님의 사랑을 전하는 헌신된 교사들은 어린이들이 매일 더 예수님을 닮아가도록 돕고 있습니다."
      imgURL={`${baseURL}bible-school.png`}
