    ...
    <div className={`inner ${style.wrapper}`}>
      <div className={style["txt-wrap"]}>
        ...
        <p className="bodyMd-m">
          도담교회의 꿈은 ‘예수를 닮아가는 믿음 공동체’로 나아가는 것입니다.
          <br />
          서로를 있는 그대로 환대하고 예수님의 사랑으로 하나되는 공동체가 되길 소망합니다. 함께 울고 웃고, 삶을 나누며
          살아가는 사람 냄새나는 따뜻한 공동체가 되길 기대합니다. 지금 어떤 삶의 여정을 걷고 계시든지 이 공간에서 편안한
          쉼과 회복을 얻고
          <br />
        ...
        <div>
          <p className={style.name}>
            <span className="bodyLg-r">담임목사</span>김도담
          </p>
        </div>
      </div>
      <div className={style["img-wrap"]}>
        <img src="/imgs/about/pastor.png" alt="도담교회 김도담목사님" />
      </div>
    </div>
  );
}
